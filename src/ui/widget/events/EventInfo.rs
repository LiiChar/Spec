...
pub fn EventInfo(props: EventInfoProps) -> Element {
    ...
    rsx! {
        div {
            class: "hidden lg:flex flex-col gap-4 w-80 p-4 bg-zinc-900/30 rounded-lg border border-zinc-700/30",
            
            // Заголовок
            h2 { 
                class: "text-lg font-bold text-cyan-400 truncate",
                "Текущее окно"
            }
            ...
            div {
                ...
                label { class: "text-xs uppercase text-gray-400 font-bold tracking-wider", "Процесс" }
                div { 
                    class: "text-sm font-semibold text-gray-200 truncate bg-zinc-800/50 rounded p-2",
                    "{window.process_name}"
                }
            }
            ...
            div {
                ...
                label { class: "text-xs uppercase text-gray-400 font-bold tracking-wider", "Заголовок" }
                div { 
            ...
            // Информация об окне
            div {
                class: "flex flex-col gap-2 pt-2 border-t border-zinc-700/50",
                ...
                div {
                    ...
                    span { 
                        class: "text-sm font-semibold text-green-400 font-mono",
                        {
                ...
                div {
                    ...
                    span { class: "text-sm font-semibold text-blue-400", "{window.rect.width}×{window.rect.height}" }
                }
                ...
                div {
                    ...
                    span { class: "text-sm font-semibold text-pink-400", "{window.rect.left}, {window.rect.top}" }
                }
            }
            ...
            div {
                ...
                label { class: "text-xs uppercase text-gray-400 font-bold tracking-wider", "Путь" }
                div { 
